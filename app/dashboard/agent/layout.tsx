        ...
        <div className="max-w-6xl mx-auto px-4 py-6 space-y-4">
          <section className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                <p className="text-xs uppercase tracking-wide text-gray-500">Agent Portal</p>
                <h1 className="text-xl sm:text-2xl font-bold text-[#0B2545]">Agent Workspace</h1>
                <p className="text-sm text-gray-600">Navegación simplificada para leads, comisiones y listados.</p>
              </div>
