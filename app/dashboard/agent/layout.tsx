      ...
      <main className="min-h-screen bg-gray-50 pb-20 md:pb-8">
        <div className="max-w-6xl mx-auto px-4 py-6 space-y-4">
          <section className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
            ...
            <div className="mt-4 grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-2 text-sm">
              ...
              <Link href="/dashboard/agent/commissions" className="text-center px-3 py-2 rounded-lg border border-gray-200 text-[#0B2545] font-medium">Commissions</Link>
