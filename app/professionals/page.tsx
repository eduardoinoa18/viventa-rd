      ...
      <section className="relative bg-[url('/hero-pro.jpg')] bg-cover bg-center rounded-lg overflow-hidden">
        <div className="bg-black/50 p-10 md:p-16">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3">
            <a href="#pricing" className="px-5 py-3 bg-[#00A6A6] text-white rounded">Ver precios</a>
            <a href="https://wa.me/18095551234" target="_blank" className="px-5 py-3 bg-white text-[#004AAD] rounded">WhatsApp</a>
          </div>
        </div>
      </section>
      ...
      <section className="mt-10 grid md:grid-cols-3 gap-6">
        {pricing.plans?.length>0 ? pricing.plans.map((p:any)=> (
          <div key={p.id||p.name} className="bg-white rounded shadow p-6">
            ...
            <a href="/apply" className="mt-4 inline-block px-4 py-2 bg-[#004AAD] text-white rounded">Solicitar acceso</a>
          </div>
        )): (
      ...
      <section className="mt-14 grid md:grid-cols-2 gap-6">
        <div className="bg-white rounded shadow p-6">
          ...
          <div className="mt-4 space-y-3">
            ...
            <button onClick={submitLead} className="px-4 py-2 bg-[#00A6A6] text-white rounded">Enviar</button>
          </div>
        </div>
        <div className="bg-white rounded shadow p-6">
          ...
          <a href="/apply" className="mt-4 inline-block px-4 py-2 bg-[#FF6B35] text-white rounded">Aplicar ahora</a>
        </div>
      </section>
    </div>
  )
